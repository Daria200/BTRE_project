...
# This is an example project. Otherwise you should put the key into invironment variables
SECRET_KEY = "django-insecure--mb$x0_g2)iwi6(1^00kkufqbkyaw)-cxph^74&8=41r@)g6un"
